...
<footer class="store-footer">
  <div class="footer-inner">
    ...
    <div class="footer-col">
      <h4>روابط</h4>
      <ul>
        <li><a href="${basePath}">متجر الجملة</a></li>
...
module.exports = function registerJomlaStore(app, getDB, CONFIG) {
  ...
  // إعدادات عامة يستخدمها الفوتر — نفس جدول landing_settings المشترك مع متجر المفرد (نفس العلامة التجارية)
  app.get('/jomla/api/site-info', async (req, res) => {
    try {
      const db = await getDB();
...
<link rel="stylesheet" href="/jomla/jomla.css?v=7">
<script type="application/ld+json">${jsonLd}</script>
</head>
<body>
<header class="store-header">
  <a href="/jomla" class="store-logo"><img src="/images/drrose-logo.png" alt="د. روز للورد"></a>
